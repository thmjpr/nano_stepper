...
#else
__attribute__((__aligned__(FLASH_ROW_SIZE))) const uint16_t NVM_flash[512] = { //allocates 512 bytes
#endif
...
bool nvmErase(void)
{
	...
	flashWrite((void *)&NVM->sPID.parametersValid, &data, sizeof(data));
	flashWrite((void *)&NVM->vPID.parametersValid, &data, sizeof(data));
	flashWrite((void *)&NVM->pPID.parametersValid, &data, sizeof(data));
	flashWrite((void *)&NVM->motorParams.parametersValid, &data, sizeof(data));
	flashWrite((void *)&NVM->SystemParams.parametersValid, &data, sizeof(data));
#ifdef NZS_FAST_CAL
