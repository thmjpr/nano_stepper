...
typedef struct {
	...
	RotationDir dirPinRotation;     //is the direction pin high for clockwise or counterClockWise
...
#else
extern  const uint16_t  NVM_flash[NVM_FLASH_SIZE_];
#endif
